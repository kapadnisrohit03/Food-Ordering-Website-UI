...
const Head = () => {
  return (
    <>
      <header
        className="
    flex justify-center items-center p-[1.5vw] shadow-2xl shadow-[#e4e4e4d9]"
      >
        <div
          className="
      flex justify-between w-[80%] items-center mr-[2vw]"
        >
          <div
            className="
        logo flex items-center ml-[-1.5vw]"
          >
            ...
            <div
              className="
          font-[800] text-gray-600 text-[14px] flex gap-[1vw] items-center"
            >
              <NavLink>
              <p
                className="
            border-b-[2px] pb-[25px] border-black h-[1vw]"
              >
                Other
              </p>
              </NavLink>
              <div
                className="
            flex items-center pt-[0.6vw]"
              >
                <i
                  className="
              fi fi-rs-angle-small-down text-2xl text-[#FC8522] mt-[-0.11vw]"
                ></i>
              </div>
            </div>
          </div>
          <nav
            className="
        flex gap-[3vw] font-[ProximaNova, arial] items-center"
          >
            <NavLink
              to="/swiggycorporate"
              
            >
              <motion.div className="flex gap-[0.5vw] font-[600] text-gray-700"
              initial = "initial"
            ...
            transition = {{
              ...
              <span className="hover:border-b-[2px] p-1 border-orange-400 hover:transition hover:translate-[2vw] mt-[-0.1vw]"
              >Swiggy Corporate</span>
              </motion.div>
            </NavLink>
            <NavLink
              to="/search"
            ...
            >
              ...
              <span className="hover:border-b-[2px] p-1 border-orange-400 hover:transition hover:translate-[2vw] mt-[-0.2vw]">
                Search
              </span>
              </motion.div>
            </NavLink>
            ...
            >
             ...
             <motion.div
              ...
              >
                <svg
                  className="_1GTCc fill-white stroke-black stroke-2 mt-[0.15vw] "
                  viewBox="-1 0 37 32"
                  height="20"
                  width="20"
                  fill="#686b78"
